...
// *************************** 例程硬件连接说明 ***************************
// 如果使用的并不是逐飞科技 cyt4bb7 主板 请按照下述方式进行接线
//      模块引脚    单片机引脚
//      PWM         查看 main.c 中 PWM_CH1  宏定义 默认 P10_2 或者 P05_2
//      DIR         查看 main.c 中 DIR_CH1  宏定义 默认 P10_3 或者 P05_3
//      SPDOUT      查看 main.c 中 ENCODER1_PLUS 宏定义 默认 P17_3 或者 P17_4
//      DIROUT      查看 main.c 中 ENCODER1_DIR  宏定义 默认 P08_1 或者 P08_2
//      GND         电源地
