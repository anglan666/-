...
// 接入方向编码器连接
//      模块管脚            单片机管脚
//      LSB                 ENCODER_DIR_PULSE 宏定义的引脚 默认 P17_3
//      DIR                 ENCODER_DIR_DIR 宏定义的引脚 默认 P17_4
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
// 接入方向编码器连接
//      模块管脚            单片机管脚
//      LSB                 ENCODER_DIR_PULSE 宏定义的引脚 默认 P19_2
//      DIR                 ENCODER_DIR_DIR 宏定义的引脚 默认 P19_3
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
...
// 4.可以在串口助手上看到如下串口信息：
//      ENCODER_DIR_1 counter ：x .
//      ENCODER_DIR_2 counter ：x .
// 5.转动编码器就会看到数值变化
