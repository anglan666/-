...
*                   ------------------------------------
*                   模块管脚            单片机管脚
*                   PCLK                P17.1 (MT9V03X_PCLK_PIN)
*                   VSYNC               P17.2 (MT9V03X_VSYNC_PIN)
*                   HREF                P5.6  (MT9V03X_HREF_PIN，预留)
*                   D0-D7               P18.0~P18.7 (MT9V03X_DATA_PIN 起连续 8 脚)
*                   SCCB SCL            P6.6  (MT9V03X_COF_IIC_SCL)
*                   SCCB SDA            P6.5  (MT9V03X_COF_IIC_SDA)
*                   VCC                 3.3V
*                   GND                 GND
*                   ------------------------------------
********************************************************************************************************************/
...
//--------------------------------------------------------------------------------------------------
// Pin Configuration - 按官方 E8_01 摄像头串口助手例程接线
// 数据总线 P18.0~P18.7 / SCCB P17.1 P17.2 / PCLK P06.5 / VSYNC P06.6 / HREF P5.6
//--------------------------------------------------------------------------------------------------
// SCCB 通讯 (Software IIC)
#define MT9V03X_COF_IIC_DELAY   ( 400   )                                       // IIC 延时
#define MT9V03X_COF_IIC_SCL     ( P17_1 )                                       // SCCB SCL -> P17.1
#define MT9V03X_COF_IIC_SDA     ( P17_2 )                                       // SCCB SDA -> P17.2

// 同步信号 (DMA 触发用，勿随意更改)
#define MT9V03X_PCLK_PIN        ( P06_5 )                                       // PCLK -> P06.5
#define MT9V03X_VSYNC_PIN       ( P06_6 )                                       // VSYNC -> P06.6
#define MT9V03X_HREF_PIN        ( P05_6 )                                       // HREF 行参考 -> P5.6（当前驱动未使用，预留）

// 数据总线 (必须连续 8 个 GPIO，DMA 源地址依赖此组)
#define MT9V03X_DATA_PIN        ( P18_0 )                                       // D0~D7 -> P18.0~P18.7
//--------------------------------------------------------------------------------------------------
